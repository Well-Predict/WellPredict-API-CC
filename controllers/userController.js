...
const getHistories = async (req, res) => {
    ...
    try{
        const histories = await knex('histories').select('histories.history_id', 'histories.user_id', 'users.name', 'histories.symptoms', 'histories.disease', 'histories.created_at').innerJoin('users', 'histories.user_id', 'users.user_id').where('histories.user_id', user_id);
